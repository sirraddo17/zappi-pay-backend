...
function startScheduler() {
  ...
  const tick = () => runDueSchedules().catch((e) => console.error('Scheduler tick failed:', e));
  setTimeout(tick, 20 * 1000);
  timer = setInterval(tick, 5 * 60 * 1000);
}

module.exports = { FREQUENCIES, nextRunAfter, createSchedule, upsertBeneficiary, runDueSchedules, startScheduler };
